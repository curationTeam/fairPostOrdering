...
\begin{itemize}
\item[i] We characterise the conditions under which our abstract Steemit algorithm converges determining the conditions under which the system  converges under honesty. Our results highlights some fundamental limitations of the actual Steemit parameterization. Specifically, \aggelos{explain here the corollary outcome}. 
\item[ii]
We validate our results with a simulation testing different metrics based on  correlation that have been proposed in previous works and relating them to our notion of convergence. 
\item[iii]
