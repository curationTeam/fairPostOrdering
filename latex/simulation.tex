\section{Simulation}
  ...
  \subsection{Results}
    ...
    \subsubsection*{Scenario A}
      ...
      \begin{figure}[!htbp]
        \includegraphics[width=0.9\textwidth]{cand1good_t_similarity}
      ...
      \begin{figure}[!htbp]
        \includegraphics[width=0.9\textwidth]{cand1good_kendall_tau}
      ...
      \begin{figure}[!htbp]
        \includegraphics[width=0.9\textwidth]{candidate1_t_similarity}
      ...
      \begin{figure}[!htbp]
        \includegraphics[width=0.9\textwidth]{candidate1_kendall_tau}
        \caption{Kendall's Tau evolution with 300 honest players, 100 posts and
        200.000 rounds}
        \label{fig:honest:100:coeffs}
      \end{figure}

      \orfeas{Maybe include graphs with rounds just short of being enough}
    ...
    \subsubsection{Scenario B: Selfish users.}
      ...
      \begin{figure}[!htbp]
        \includegraphics[width=0.9\textwidth]{cand2_positionsgained}
      ...
      \begin{figure}[!htbp]
        \includegraphics[width=0.9\textwidth]{cand2_t-convergence}
