\begin{proof}
  \begin{itemize}
    ...
    \begin{gather*}
      \mathrm{sc}_{\rounds}\left(\postlist\left[i\right]\right) \leq
      c\left(\frac{\playerlen - 1}{2}\left(\mathrm{reducedVP} \cdot \gamma a +
      ...
      \mathrm{reducedVP} \cdot \gamma a + b\right) \enspace.
    \end{gather*}
    ...
    \begin{equation*}
      ...
      \mathrm{reducedVP}\right) \enspace.
    \end{equation*}
  \end{itemize}
\end{proof}
