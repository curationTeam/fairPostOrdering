...
\begin{remark}
  We omit Steem Power, the voting-related currency of Steem that helps to
  mitigate Sybil attacks from our model. Our main result
  (Theorem~\ref{theorem:convergence:steem},
  Corollary~\ref{corollary:convergence:steem}) operates with a set of
  independent non-Sybil players.
\end{remark}
