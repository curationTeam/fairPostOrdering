...
\begin{remark}
  We omit Steem Power, the voting-related currency of Steem that helps to mitigate Sybil attacks from our analysis. Our model operates with a set of $N$ players that are assumed to be independent non-Sybils.
\end{remark}
