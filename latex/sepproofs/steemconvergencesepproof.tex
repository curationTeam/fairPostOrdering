\begin{sepproof}{Proof of Theorem~\ref{theorem:convergence:steem}: Steem
convergence}
  \begin{itemize}
    ...
    \begin{gather*}
      \weakpost = \left(1, \left(\underbrace{1, \dots, 1}_{k - 1},
      \underbrace{\gamma - \epsilon, \dots, \gamma - \epsilon}_{k - 1}, \gamma,
      \gamma\right)\right) \enspace, \\
      \strongpost = \left(1, \left(\underbrace{\gamma, \dots, \gamma}_{k - 1},
      \underbrace{1, \dots, 1}_{k - 1}, \gamma, \gamma\right)\right) \enspace,
      \\
    ...
    \begin{gather*}
      \weakpost = \left(1, \left(\underbrace{1, \dots, 1}_{k},
      \underbrace{\gamma - \epsilon, \dots, \gamma - \epsilon}_{k},
      \gamma\right)\right) \enspace, \\
      \strongpost = \left(1, \left(\underbrace{\gamma, \dots, \gamma}_{k},
      \underbrace{1, \dots, 1}_{k}, \gamma\right)\right) \enspace, \\
      \postlist = \left[\weakpost, \strongpost, \underbrace{\nullpost, \dots,
      \nullpost}_{\postlen - 2}\right] \enspace.
    \end{gather*}
    We first observe that $\forall j \in \left\{3, \dots, \postlen\right\},
    ...
    \begin{equation*}
      \postlist = \left[\left(1, \left(1, 0\right)\right), \left(1,
      \left(\gamma, 1 - \gamma\frac{1 + \rvp}{2}\right)\right),
      \underbrace{\nullpost, \dots, \nullpost}_{\postlen - 2}\right] \enspace.
    \end{equation*}
